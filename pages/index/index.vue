	...
	<view class="content">
		<view  :class="isShowList?'router-view-click':'router-view'">
			<view class="filter-games">
				...
				<view>游戏筛选</view>
				<view class="hide-filter-games-btn" @click="close">
		...
		<view class="tui-mtop"><tui-tabs :tabs="tabs" :currentTab="currentTab > 4 ? 0 : currentTab" bgColor="#090c15" @change="change" itemWidth="20%" ></tui-tabs></view>
		...
		<swiper  class="swiper" :current="currentTab" :duration="300" @change="swiperChange" :style="'height:'+ scrollH +'px;'">
			<swiper-item v-for="(item,index) in tabs " :key='index'>
				<view class="swiper-item">
					<scroll-view scroll-y="true" @scrolltoupper="downRefresh" @scrolltolower="loadMore" :style="'height:'+ scrollH +'px;'" class="scroll-list" refresher-enabled="true" refresher-background="#090c15">
						<view class="list">
							<view class="list-item" @click="toDetail">
								...
								<view class="body">
									<view class="body-team">
										<image src="/static/images/icon7.png"  class="team-logo"></image>
									</view>
									...
									<view class="body-team">
										<image src="/static/images/icon8.png"  class="team-logo"></image>
									</view>
								</view>
